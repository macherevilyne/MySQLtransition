DROP TABLE IF EXISTS `MonetPolData_PB`;
CREATE TABLE IF NOT EXISTS `MonetPolData_PB` AS
    SELECT
        ...
        Manipulation1.CommModel, Manipulation1.RIModel,
        ...
        Manipulation1.FundAccValDat * ROE.EUR AS FundAccValDat,
    ...
    WHERE
        Manipulation1.FundAccValDat * ROE.EUR > 0 AND Manipulation1.Product LIKE 'PB*'
    ORDER BY
        Manipulation1.PolNo;