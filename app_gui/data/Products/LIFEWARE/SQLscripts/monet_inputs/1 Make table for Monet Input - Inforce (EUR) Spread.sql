DROP TABLE IF EXISTS `MonetPolData_Spread`;
CREATE TABLE IF NOT EXISTS `MonetPolData_Spread` AS
    SELECT
    ...
    WHERE
        (1 - Manipulation1.PercBonds * Manipulation1.`Spread shock`) * Manipulation1.FundAccValDat > 0 AND
