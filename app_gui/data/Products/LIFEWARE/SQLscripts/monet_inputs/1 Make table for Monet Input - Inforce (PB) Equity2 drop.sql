DROP TABLE IF EXISTS `MonetPolData_Eq2DropPB`;
CREATE TABLE IF NOT EXISTS `MonetPolData_Eq2DropPB` AS
    SELECT
        ...
        (1 - Manipulation1.PercStocks2 * Manipulation1.[Equity2 shock]) * Manipulation1.FundAccValDat * ROE.EUR AS FundAccValDat,
    ...
    WHERE
        (1 - Manipulation1.PercStocks2 * Manipulation1.[Equity2 shock]) * Manipulation1.FundAccValDat * ROE.EUR > 0 AND Manipulation1.Product LIKE 'PB*'
    ORDER BY
        Manipulation1.PolNo;