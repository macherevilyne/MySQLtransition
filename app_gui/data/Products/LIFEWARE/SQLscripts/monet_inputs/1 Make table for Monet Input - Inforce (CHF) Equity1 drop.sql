DROP TABLE IF EXISTS `MonetPolData_Eq1DropCHF`;
CREATE TABLE IF NOT EXISTS `MonetPolData_Eq1DropCHF` AS
    SELECT
    ...
    WHERE ((1 - Manipulation1.PercStocks1 * Manipulation1.`Equity1 shock`) * Manipulation1.FundAccValDat) > 0 AND Manipulation1.Product = 'Swiss'
