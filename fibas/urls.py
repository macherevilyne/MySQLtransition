...
urlpatterns = [
    ...
    path('fibas_custom_macros_list/<str:db_name>/', views.FibasUserHistoryCustomMacrosListView.as_view(), name='fibas_custom_macros_list'),
    ...
    path('macros/fibas-create-custom-macros/<str:db_name>/', views.UserCreateCustomMacrosView.as_view(), name='fibas_create_custom_macros'),
    ...
    path('delete_custom_macros_query/<int:query_id>/delete/', views.delete_custom_macros_query, name='delete_custom_macros_query'),
    ...
    path('execute_custom_macros/<int:macros_id>/', views.ExecuteCustomMacrosView.as_view(), name='execute_custom_macros'),
