DROP TABLE IF EXISTS `MonetPolData_Eq2Drop`;
CREATE TABLE IF NOT EXISTS `MonetPolData_Eq2Drop` AS
    SELECT
    ...
    WHERE
        (1 - Manipulation1.PercStocks2 * Manipulation1.`Equity2 shock`) * Manipulation1.FundAccValDat > 0 AND
