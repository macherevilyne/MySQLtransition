DROP TABLE IF EXISTS `MonetPolData_IDown`;
CREATE TABLE IF NOT EXISTS `MonetPolData_IDown` AS
    SELECT
    ...
    WHERE
        (1 - Manipulation1.PercBonds * Manipulation1.`Bond shock`) * Manipulation1.FundAccValDat > 0 AND
