DROP TABLE IF EXISTS `MonetPolData_Eq1DropPB`;
CREATE TABLE IF NOT EXISTS `MonetPolData_Eq1DropPB` AS
    SELECT
        ...
        Manipulation1.AdhocContribution * ROE.EUR AS AdhocContribution, Manipulation1.TermPrem,
        Manipulation1.Term,
        ...
        (1 - Manipulation1.PercStocks1 * Manipulation1.[Equity1 shock]) * Manipulation1.FundAccValDat * ROE.EUR AS FundAccValDat,
    ...
    WHERE
        (1 - Manipulation1.PercStocks1 * Manipulation1.[Equity1 shock]) * Manipulation1.FundAccValDat * ROE.EUR > 0 AND Manipulation1.Product LIKE 'PB*'
    ORDER BY
        Manipulation1.PolNo;