DROP TABLE IF EXISTS `MonetPolData_IDownPB`;
CREATE TABLE IF NOT EXISTS `MonetPolData_IDownPB` AS
    SELECT
        ...
        (1 - Manipulation1.PercBonds * Manipulation1.[Bond shock]) * Manipulation1.FundAccValDat * ROE.EUR AS FundAccValDat,
    ...
    WHERE
        (1 - Manipulation1.PercBonds * Manipulation1.[Bond shock]) * Manipulation1.FundAccValDat * ROE.EUR > 0 AND Manipulation1.Product LIKE 'PB*'
    ORDER BY
        Manipulation1.PolNo;