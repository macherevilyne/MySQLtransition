DROP TABLE IF EXISTS `MonetPolData_Eq2DropCHF`;
CREATE TABLE IF NOT EXISTS `MonetPolData_Eq2DropCHF` AS
    SELECT
        ...
        (1 - Manipulation1.PercStocks2 * Manipulation1.`Equity2 shock`) * Manipulation1.FundAccValDat AS FundAccValDat,
    ...
    WHERE ((1 - Manipulation1.PercStocks2 * Manipulation1.`Equity2 shock`) * Manipulation1.FundAccValDat) > 0 AND Manipulation1.Product = 'Swiss'
