DROP TABLE IF EXISTS `MonetPolData_SpreadCHF`;
CREATE TABLE IF NOT EXISTS `MonetPolData_SpreadCHF` AS
    SELECT
        ...
        (1 - Manipulation1.PercBonds * Manipulation1.`Spread shock`) * Manipulation1.FundAccValDat AS FundAccValDat,
    ...
    WHERE ((1 - Manipulation1.PercBonds * Manipulation1.`Spread shock`) * Manipulation1.FundAccValDat) > 0 AND Manipulation1.Product = 'Swiss'
