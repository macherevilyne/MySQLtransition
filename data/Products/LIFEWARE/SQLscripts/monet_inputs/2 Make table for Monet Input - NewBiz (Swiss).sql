DROP TABLE IF EXISTS `MonetPolData NewBiz Swiss`;
CREATE TABLE IF NOT EXISTS `MonetPolData NewBiz Swiss` AS
    SELECT
    ...
    WHERE
        ...
        ((Manipulation1.Gewinnverband) = "LUX" OR (Manipulation1.Gewinnverband) = "KID")
    ORDER BY
        Manipulation1.PolNo;